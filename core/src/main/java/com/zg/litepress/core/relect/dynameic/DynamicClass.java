package com.zg.litepress.core.relect.dynameic;


import com.zg.litepress.core.bean.entity.MetadataEntity;
import com.zg.litepress.core.init.Evn;
import com.zg.litepress.core.relect.bytebuddy.DynamicClassGenerator;
import com.zg.litepress.core.util.CommonUtil;
...
public class DynamicClass {
    ...
    private static String produceEntityJavaCode(List<String> referenceList, String calssName, String tableName, List<MetadataEntity> columnList, List<String> interfaceList, String parentClass) throws Exception {
        ...
        if (calssName == null || columnList.size() == 0) {
            ...
            sb.append("package com.zg.litepress.core.bean.entity;\r\n");
...
/*        Class model = null;
        if (columnList != null && columnList.size() > 0) {
            ...
            List importList = Arrays.asList("com.zg.litepress.core.bean.entity.MainModel",
