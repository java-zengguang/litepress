...
import com.zg.common.error.SysException;
import com.zg.common.handler.TransactionHandler;
...
public class ProxyUtils {
    ...
    public static Object getRemotingProxy(Object obj,String providerName) {
        ...
        try {
            ...
            targetObject = Proxy.newProxyInstance(obj.getClass().getClassLoader(), obj.getClass().getInterfaces(), proxyObject);
