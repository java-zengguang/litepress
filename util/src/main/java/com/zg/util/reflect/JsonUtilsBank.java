        ...
        if(obj==null){
           ...
           if (obj instanceof Collection) {
                ...
                for (Field f : fields) {
                    ...
                    if (!FieldUtils.isPrimitive(f) && f.get(obj)!=null && !FieldUtils.isPrimitive(f.get(obj))) {
        ...
        if (map == null) {
            ...
            for (String key : keySet) {
                ...
                if (value instanceof Map) {
                    ...
                    json.put(key, objectToJson(value));
                }
        ...
        for(Field field:fields){
            ...
            if(FieldUtils.isPrimitive(field)){
                ...
                if(value!=null && value instanceof Map ){
                    value= JsonUtilsBank.mapToJson((Map)value).toString();
                }
