...
public class LoginDao {
    ...
    public List login(Map map) throws NoSuchFieldException, IllegalAccessException, SQLException {
    ...
    public int insertToken(Map map) throws SQLException, NoSuchFieldException, IllegalAccessException {
       // MongoDBUtils.insertOneMap("loginToken",new Document(map));
        ...
        sql= ModelSQLUtils.dynamicSQL(sql,map);
        Integer x=JDBCUtils.operation(sql);
        return x;
    }


    public List<Map> selectToken(Map map) throws NoSuchFieldException, IllegalAccessException, SQLException {
    ...
    public List<Map> isLogin(String uuid,String token) throws SQLException {
        String sql="select status from user_login where  uuid='"+uuid+"' and token_id='"+token+"' ";
        List list=JDBCUtils.selectToMapList(sql);
        return list;
    }

    public int updateLoginStatus(String uuid, String token,String key) throws SQLException {
        String sql="";
