...
import com.zg.sinosig.introduce.SVNSimpleIntroduceSQL;
...
import com.zg.sinosig.report.SVNSimpleReportBataBase;
...
public class SQLExcuteTask implements Job {
    ...
    private List<SinoSigSQLLogEntity> doExecute() throws Exception {
        ...
        //执行结果同步svn
        if(true){
            ReportDataBase sqlExecuteResult=new SVNSimpleReportBataBase();
